...
class TestEpjson2Rad(unittest.TestCase):
    ...
    def test_cfscase(self):
        ...
        self.assertTrue(os.path.isfile("./Objects/Room_102_Wall.rad"))
        self.assertTrue(os.path.isfile("./Objects/Room_102_Window.rad"))
        self.assertTrue(os.path.isfile("./Objects/Room_102_Ceiling.rad"))
    ...
    def test_refcase(self):
        ...
        self.assertTrue(os.path.isfile("./Objects/Perimeter_bot_ZN_1_Wall.rad"))
