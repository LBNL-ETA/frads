...
def window_primitives(window_polygon):
    return [
        pr.Primitive(
            "void", "polygon", "window1", ("0"), window_polygon[0].coordinates
        ),
        pr.Primitive(
            "void", "polygon", "window2", ("0"), window_polygon[1].coordinates
        ),
    ]
...
def test_surface_as_receiver(window_primitives):
    ...
    out = None
    offset = 0.1
    receiver = matrix.SurfaceReceiver(window_primitives, basis, out=out, offset=offset)
