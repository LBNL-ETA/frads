...
nprocess = 1
overwrite = False
File structure section of the configuration need not to be changed unless the user elect to having a different
[File structure]
base = /Users/admin/test
matrices = Matrices
results = Results
objects = Objects
resources = Resources
